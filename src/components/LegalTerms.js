...
function LegalTerms(props) {
  return (
    <LongContent>
      ...
      <p>Last updated: 10/05/2022</p>

      <h2>1. Introduction</h2>
      <p>
        Welcome to Realest System (“Company”, “we”, “our”, “us”)! As you have
      ...
      <p>
        ...
        our web pages located at https://www.realestsystem.com/ operated by
        Realest System.
      </p>
      ...
      <p>
        ...
        https://www.realestsystem.com/legal/privacy-policy.
      </p>
      ...
      <p>
        ...
        hello@realestsystem.com so we can try to find a solution. These Terms
      ...
      <p>
        ...
        renew under the exact same conditions unless you cancel it or Realest
        System cancels it. You may cancel your Subscription renewal either
        through your online account management page or by contacting Realest
        System customer support team.
      </p>

      <p>
        A valid payment method, including credit card, is required to process
        the payment for your subscription. You shall provide Realest System with
        ...
        authorize Realest System to charge all Subscription fees incurred
        through your account to any such payment instruments.
      </p>

      <p>
        Should automatic billing fail to occur for any reason, Realest System
      ...
      <h2>6. Free Trial</h2>
      <p>
        Realest System may, at its sole discretion, offer a Subscription with a
      ...
      <p>
        ...
        you will not be charged by Realest System until Free Trial has expired.
      ...
      <p>
        At any time and without notice, Realest System reserves the right to (i)
      ...
      <h2>7. Fee Changes</h2>
      <p>
        Realest System, in its sole discretion and at any time, may modify
      ...
      <p>
        Realest System will provide you with a reasonable prior notice of any
      ...
      <p>
        Realest System has the right but not the obligation to monitor and edit
      ...
      <p>
        ...
        Realest System and its licensors. Service is protected by copyright,
        ...
        the prior written consent of Realest System.
      </p>
      ...
      <p>
        ...
        to hello@realestsystem.com, with the subject line: “Copyright
      ...
      <p>
        You can contact our Copyright Agent via email at hello@realestsystem.com
      </p>

      <h2>17. Error Reporting and Feedback</h2>
      <p>
        You may provide us directly at hello@realestsystem.com with information
      ...
      <p>
        ...
        are not owned or controlled by Realest System.
      </p>

      <p>
        Realest System has no control over, and assumes no responsibility for
      ...
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT REALEST SYSTEM SHALL NOT BE RESPONSIBLE
      ...
      <p>By email: hello@realestsystem.com.</p>
    </LongContent>
  );
}
