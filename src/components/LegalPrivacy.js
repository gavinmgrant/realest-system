...
function LegalPrivacy(props) {
  return (
    <LongContent>
      ...
      <p>Welcome to Realest System.</p>
      <p>
        Realest System (“us”, “we”, or “our”) operates
        https://www.realestsystem.com/ (hereinafter referred to as “Service”).
      </p>

      <p>
        Our Privacy Policy governs your visit to https://www.realestsystem.com/,
      ...
      <p>
        ...
        Conditions.We use your data to provide and improve Service. By using
      ...
      <h2>2. Definitions</h2>
      <p>
        SERVICE means the https://www.realestsystem.com/ website operated by
        Realest System.
      </p>
      <p>
      ...
      <h2>5. Use of Data</h2>
      <p>Realest System uses the collected data for various purposes:</p>
      ...
      <p>
        Realest System will take all the steps reasonably necessary to ensure
      ...
      <p>
        (b) our Privacy Policy link includes the word “Privacy”, and can easily
      ...
      <p>
        Realest System uses remarketing services to advertise on third party
